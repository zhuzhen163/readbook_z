...
public class CircleProgressBar extends View {
     ...
     */
    public void setCountdownProgressListener(OnCircleProgressListener mCountdownProgressListener) {
    ...
    private Runnable progressChangeTask = new Runnable() {
        ...
        public void run() {
            ...
            progress +=12;
            postInvalidate();
            centerText = Integer.toString((progress/12));
            if (progress == 360){
                progress = 0;
                mCountdownProgressListener.onProgress(Integer.parseInt(centerText));
            }
