...
import com.huajie.readbook.utils.UtilsView;
import com.huajie.readbook.widget.animation.CoverPageAnim;
import com.huajie.readbook.widget.animation.HorizonPageAnim;
import com.huajie.readbook.widget.animation.NonePageAnim;
import com.huajie.readbook.widget.animation.PageAnimation;
import com.huajie.readbook.widget.animation.ScrollPageAnim;
import com.huajie.readbook.widget.animation.SimulationPageAnim;
import com.huajie.readbook.widget.animation.SlidePageAnim;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()){
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mPageAnim instanceof NonePageAnim) break;//如果无动画滑动不翻页
                //如果滑动了，则进行翻页。
                if(isMove){
                    mPageAnim.onTouchEvent(event);
                }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!isMove){
                    //设置中间区域范围
                    if (mCenterRect == null){
                        mCenterRect = new RectF(mViewWidth/3,0,
                                mViewWidth*2/3,mViewHeight);
                    }
