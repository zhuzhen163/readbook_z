...
import com.huajie.readbook.utils.SharedPreUtils;
...
public class ReadSettingManager {
    ...
    public void setTextLineSpace(int textSize){
        sharedPreUtils.putInt(SHARED_READ_TEXT_LINE_SPACE,textSize);
    }
    ...
    public int getBrightness(){
        return sharedPreUtils.getInt(SHARED_READ_BRIGHTNESS, 90);
    }
    ...
    public int getTextLineSpace(){
        return sharedPreUtils.getInt(SHARED_READ_TEXT_LINE_SPACE, 60);
    }
