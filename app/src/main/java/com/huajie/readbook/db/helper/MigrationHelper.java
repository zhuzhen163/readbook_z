...
public class MigrationHelper {
    ...
    private void generateTempTables(Database db, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        for (int i = 0; i < daoClasses.length; i++) {
            ...
            LogUtil.i("lxq", "创建临时表的SQL语句： " + createTableStringBuilder.toString());
            ...
            LogUtil.i("lxq", "在临时表插入数据的SQL语句：" + insertTableStringBuilder.toString());
    ...
    private void restoreData(Database db, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        for (int i = 0; i < daoClasses.length; i++) {
            ...
            LogUtil.i("lxq", "插入正式表的SQL语句：" + insertTableStringBuilder.toString());
            LogUtil.i("lxq", "销毁临时表的SQL语句：" + dropTableStringBuilder.toString());
            db.execSQL(insertTableStringBuilder.toString());
