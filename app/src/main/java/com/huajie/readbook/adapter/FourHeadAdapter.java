 ...
 */
public class FourHeadAdapter extends BaseAdapter {

    private List<BookBean> list;
    private LayoutInflater layoutInflater;
    private Context context;

    public FourHeadAdapter(Context context, List <BookBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.view_head_adapter_4, null);
