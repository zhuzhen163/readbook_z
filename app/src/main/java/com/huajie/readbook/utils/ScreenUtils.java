...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = ZApplication.getAppContext().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = ZApplication.getAppContext().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics() {
        DisplayMetrics metrics = ZApplication.getAppContext()
                .getResources()
                .getDisplayMetrics();
        return metrics;
    }
